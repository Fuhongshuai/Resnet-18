...
ckpt_dir = current_dir + '/checkpoint/'
...
tf.app.flags.DEFINE_string('train_image_root', train_dir, """Path to the root of ILSVRC2012 training images""")
tf.app.flags.DEFINE_string('val_dataset', 'scripts/val.txt', """Path to the test dataset list file""")
tf.app.flags.DEFINE_string('val_image_root', test_dir, """Path to the root of ILSVRC2012 test images""")
#tf.app.flags.DEFINE_string('mean_path', './ResNet_mean_rgb.pkl', """Path to the imagenet mean""")
tf.app.flags.DEFINE_integer('num_classes', 8, """Number of classes in the dataset.""")
tf.app.flags.DEFINE_integer('num_train_instance', 4, """Number of training images.""")
tf.app.flags.DEFINE_integer('num_val_instance', 4, """Number of val images.""")
...
tf.app.flags.DEFINE_string('train_dir', ckpt_dir, """Directory where to write log and checkpoint.""")
tf.app.flags.DEFINE_integer('max_steps', 5, """Number of batches to run.""")
tf.app.flags.DEFINE_integer('display', 1, """Number of iterations to display training info.""")
tf.app.flags.DEFINE_integer('val_interval', 1, """Number of iterations to run a val""")
tf.app.flags.DEFINE_integer('val_iter', 1, """Number of iterations during a val""")
tf.app.flags.DEFINE_integer('checkpoint_interval', 1, """Number of iterations to save parameters as a checkpoint""")
